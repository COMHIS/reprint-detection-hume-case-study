...
Part of the [reprint-detection-hume-case-study](../README.md) repository.
The stage above this one, which turns pairs into reviewable historical
events, is in [`../dsh-event-level`](../dsh-event-level).
